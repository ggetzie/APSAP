...
class manual_match_widget(QWidget):
    def __init__(self,main_widget):
        ...
        reference_image_path = os.path.join(basedir, 'assets' ,'reference_placeholder.png') 
        self.batch_image_display_label.setPixmap(QPixmap(reference_image_path).scaledToHeight(300))
    ...
    def open_batch_image_in_gui(self,item):
        batch_reference_path = str(self.context_folder) + "\\" + item.text().split(' ')[0] + "\\registration_reso1_maskthres242\\final_output\\00_corres_img_pieces.png"
