...
class LoadPlys:
    def populate_models(self):
        """
            A rather long function that simply put all the 3d models in the list. The complicatedness lies in the fact that 
            1)
        """
            ...
            for item in items:
                ...
                #(4)If we dont have the information yet, we have to calculate it ourselves, we also need to save the calcuated data into the json_data, past_records, so that we don't have to recalculuate it next time.
                    ...
                    temp = {
                        ...
                        "cirlcle_area_ratio": cirlcle_area_ratio, "brightness_summary": brightness_summary,
