...
class CalculateSimilarityMixin:  # bridging the view(gui) and the model(data)
    ...
    def get_similaritiy_scores(self, index,  image_path):
        ...
        _2d_area_image_1 = main_controller.get_2d_picture_area(_2d_image_path_image_1)
        _2d_area_image_2 = main_controller.get_2d_picture_area(_2d_image_path_image_2)    
 
        #Brightness based simliarity
        color_brightness_2d_image_2 = main_controller.get_brightness_summary_from_2d(_2d_image_path_image_2)
        color_brightness_2d_image_1 = main_controller.get_brightness_summary_from_2d(_2d_image_path_image_1)
        ...
        front_color = (main_controller.get_color_summary_from_2d(_2d_image_path_image_1))
        back_color = (main_controller.get_color_summary_from_2d(_2d_image_path_image_2))  
        
        #Fourth one, width length
        _2d_width_length_image_1 = (main_controller.get_2d_width_length(_2d_image_path_image_1))
        _2d_width_length_image_2 = (main_controller.get_2d_width_length(_2d_image_path_image_2))
        #Getting the simlarity scores here 
        _2d_area_circle_ratio_image_1 = main_controller.get_2d_area_circle_ratio(_2d_image_path_image_1)
        _2d_area_circle_ratio_image_2 = main_controller.get_2d_area_circle_ratio(_2d_image_path_image_2)
    ...
    def get_area_circle_similarity(self, _2d_area_circle_ratio_image_1,_2d_area_circle_ratio_image_2, all_3d_area_circle_ratio, a, b):
        main_model, main_view, main_controller = self.get_model_view_controller()
        if(main_controller.get_similarity_two_nums(_2d_area_circle_ratio_image_1, all_3d_area_circle_ratio) >  main_controller.get_similarity_two_nums(_2d_area_circle_ratio_image_2, all_3d_area_circle_ratio) ):
            
             return main_controller.get_similarity_two_nums(_2d_area_circle_ratio_image_2 * a + b, all_3d_area_circle_ratio)  
        else:
             return main_controller.get_similarity_two_nums(_2d_area_circle_ratio_image_1 * a + b, all_3d_area_circle_ratio)  
    ...
    def get_similarity(self, _3d_area, _2d_area_1, _2d_area_2, _3d_brightness, _2d_brightness_1, _2d_brightness_2, _3d_brightness_std, _2d_brightness_std_1, _2d_brightness_std_2, _3d_pic_side_1, _3d_pic_side_2, _first_pic_side_1, _first_pic_side_2, _second_pic_side_1, _second_pic_side_2,  _2d_area_circle_ratio_image_1,_2d_area_circle_ratio_image_2, all_3d_area_circle_ratio):
        ...
        area_similarity = main_controller.get_area_similarity(_3d_area, _2d_area_1, _2d_area_2,parameters["area"]["slope"], parameters["area"]["intercept"])
        brightness_similarity = main_controller.get_brightness_similarity(_3d_brightness, _2d_brightness_1, _2d_brightness_2,parameters["brightness"]["slope"], parameters["brightness"]["intercept"])
        brightness_std_similarity = main_controller.get_brightness_std_similarity(_3d_brightness_std, _2d_brightness_std_1, _2d_brightness_std_2,parameters["brightness_std"]["slope"], parameters["brightness_std"]["intercept"])
        width_length_similarity = main_controller.get_width_length_similarity(_3d_pic_side_1, _3d_pic_side_2, _first_pic_side_1,  _first_pic_side_2, _second_pic_side_1, _second_pic_side_2,parameters["width"]["slope"], parameters["width"]["intercept"],parameters["length"]["slope"], parameters["length"]["intercept"])
        area_circle_similarity = main_controller.get_area_circle_similarity(_2d_area_circle_ratio_image_1,_2d_area_circle_ratio_image_2, all_3d_area_circle_ratio, 0.9055558282782922, 0.03996414943733839)
    ...
    def get_area_similarity(self, _3d_area, _2d_area_1, _2d_area_2, a, b):
        ...
        if(main_controller.get_similarity_two_nums(smaller_area, _3d_area) >  main_controller.get_similarity_two_nums(larger_area, _3d_area) ):
            #We use a and b to get a more accurate similarity.
            return main_controller.get_similarity_two_nums(larger_area * a + b, _3d_area)  
        else:
             return main_controller.get_similarity_two_nums(smaller_area * a + b, _3d_area)  
    ...
    def get_brightness_similarity(self, _3d_brightness, _2d_brightness_1, _2d_brightness_2, a, b):
        ...
        if(main_controller.get_similarity_two_nums(darker_brightness, _3d_brightness) >  main_controller.get_similarity_two_nums(brighter_brightness, _3d_brightness) ):
           
            return main_controller.get_similarity_two_nums(brighter_brightness * a + b, _3d_brightness)  
        else:
             return main_controller.get_similarity_two_nums(darker_brightness * a + b, _3d_brightness)  
    ...
    def get_brightness_std_similarity(self, _3d_brightness_std, _2d_brightness_std_1, _2d_brightness_std_2, a, b):
        ...
        if(main_controller.get_similarity_two_nums(smaller_brightness_std, _3d_brightness_std) >  main_controller.get_similarity_two_nums(larger_brightness_std, _3d_brightness_std) ):
           
            return main_controller.get_similarity_two_nums(larger_brightness_std * a + b, _3d_brightness_std)  
        else:
             return main_controller.get_similarity_two_nums(smaller_brightness_std * a + b, _3d_brightness_std)  
    ...
    def get_width_length_similarity(self, _3d_pic_side_1, _3d_pic_side_2, _first_pic_side_1, _first_pic_side_2, _second_pic_side_1, _second_pic_side_2, a, b, c, d):
        ...
        unadjusted_similarity_1  = (main_controller.get_similarity_two_nums(longer_side_pic_1, longer_side_3d ) +  main_controller.get_similarity_two_nums( shorter_side_pic_1, shorter_side_3d ))/2
        unadjusted_similarity_2  = (main_controller.get_similarity_two_nums(longer_side_pic_2, longer_side_3d ) +  main_controller.get_similarity_two_nums(shorter_side_pic_2, shorter_side_3d))/2
        if(unadjusted_similarity_1 > unadjusted_similarity_2):
            result = (main_controller.get_similarity_two_nums( shorter_side_pic_2* a + b, shorter_side_3d ))+ main_controller.get_similarity_two_nums(longer_side_pic_2* c + d, longer_side_3d   ) /2
        else:
            result = (main_controller.get_similarity_two_nums( shorter_side_pic_1* a + b, shorter_side_3d ) + main_controller.get_similarity_two_nums(longer_side_pic_1* c + d, longer_side_3d   ) )/2
